...
def StripeAutomate(credit_card, firstname="Kardur", lastname="Sosayati"):
    ...
    result_data = {
        ...
        'stripeToken': stripe_response['id'],
        'stripe_plan': 'STDmonthly199',
        'amount': '1.99',
        'planid': 'STD',
        'planprice': '1.99',
    ...
    try:
        ...
        if 'code' in res.lower():
            print("LIVE\t----\t" + credit_card + ' => ' + res.replace("\n", ""))
            return("LIVE\t----\t" + credit_card + ' => ' + res.replace("\n", ""))
        else:
            print("DEAD\t----\t" + credit_card + ' => ' + res.replace("\n", ""))
